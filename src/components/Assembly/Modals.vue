  ...
  <div class="popup-finished">
    <div class="popup-finished__info">
      ...
      <p
        ...
        v-html="
          translate(
            'Впереди — составление маршрутного задания. Это подробный план полёта. Оно помогает оператору следовать по заданным точкам, <br /> в которых нужно делать фото и видео. Приступим?'
          )
        "
      ></p>
    </div>
