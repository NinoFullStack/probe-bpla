  ...
  <div class="popup-finished">
    <div class="popup-finished__info">
      <div class="popup-finished__header">
        <h3 class="popup-finished__title">{{ translate('Выбор сделан!') }}</h3>
      </div>
      <p
        class="popup-finished__paragraph"
        v-html="
          translate(`
          Перед запуском вам необходимо собрать беспилотный комплекс <br />
          и провести все необходимые технические проверки: диагностику <br />
          и калибровку систем.`)
        "
      ></p>
    </div>
